...
?aes
plot(plays$playResult, plays$expectedPointsAdded, main="Expected points added and yards gained on the play", xlab = "Yards gained on the play", ylab = "Expected number of points added")
...
plot(shotgun$playResult, shotgun$expectedPointsAdded, main="Expected points added based on yards gained on shotgun plays", xlab = "Yards gained on the play", ylab = "Expected number of points added")
